export const GAMES = {
  agameaboutme: {
    ...
    video: require("../games/agameaboutme/AGameAboutMe.mp4"),
    ...
    description: (
      <>
        <p>Font: Crayon Libre Font</p>
        <p>Music: Pixabay, Youtube and other source</p>
        <p>
          Thank you Lect. Toby and Lect. Duy Phan for playing testing and
          advising.
        </p>
      </>
    ),
  ...
  dfishyfinal: {
    ...
    video: require("../games/dfishyfinal/DFishyFinal.mp4"),
    ...
    description: (
      <>
        <h3>Description:</h3>
        <p>
          Two comrades in crime with the mission to improve their academic
          performances in the most unethical way possible, not knowing they
          would discover a secret within the “schul”
        </p>
        <h3>Tags:</h3>
        <p>
          Stealth, running sim, high school crime, man stop saying I know what
          I'm doing, kids do not follow
        </p>
        <h3>Objective:</h3>
        <p>
          Steal the exam folder, scan the exam folder, become valedictorians,
          work at NASA (optional)
        </p>
      </>
    ),
    category: "story",
  ...
  //   short: (
  //     <>
  //       Walk your scaredy-cat friend home by going down a dark hallway together.
  //     </>
  //   ),
  //   description: (
  //     <>
  //       <p>
  //         “Walk your scaredy-cat friend home by going down a dark hallway
  //         together.
  //       </p>
  //       <p>Actually, make that two scaredy-cats. You’re no better than him.”</p>
  //       <p>
  //         (Partially based on a true story… depending on the ending you get.)
  //       </p>
  //     </>
  //   ),
  //   category: "arcade",
  ...
  firstprinciple: {
    ...
    video: require("../games/firstprinciple/FirstPrinciple.mp4"),
    ...
    description: (
      <>
        ...
        <p>
          Gems of opposing force (Fire &gt;&lt; Water, Air&nbsp;&gt;&lt;
          Earth)&nbsp;will push each other if they're adjacent. If&nbsp;two gems
          of the same element collides, it creates a Gold Gem. Otherwise, it
          creates a Black Gem. Gold Gem &amp; Black Gem cannot move, and will
          absorb all gems when colliding.
        </p>
        <p>
          <strong>Freeplay</strong>: The goal is to have as many Gold Gems as
          possible on the board until you can no longer put more gems on.
        </p>
        <p>
          <strong>Puzzle</strong>: The goal is to create the specified number of
          Gold Gems. Only Water Gem will spawn.
        </p>
        <p>
          <strong>PvP</strong>: Same rule as Freeplay, but whenever you create a
          Black Gem, you also create it in your opponent's board. Black Gems
          will absorb all but Gold Gems.&nbsp;Whoever created more Gold Gems
          wins.
        </p>
        <p>BGM &amp; SFX: Pixabay</p>
      </>
  ...
  insidemy10yearoldhead: {
    ...
    video: require("../games/insidemy10yearoldhead/InsideMy10YearOldHead.mp4"),
    ...
    description: (
      <>
        <p>
          Inside my 10-year-old head is a flat game about my frustration and
  ...
  mamapleasewait: {
    ...
    video: require("../games/mamapleasewait/MamaPleaseWait.mp4"),
    ...
    description: (
      <>
        ...
        <p>
          &nbsp;• The player controls the leading chick. Their objective is to
          balance it while it walks, via the left and right mouse.&nbsp;
        </p>
        <p>• The longer they walk, the faster the game becomes.&nbsp;</p>
        <p>• Their progress is recorded through a km distance display</p>
        <p>
          • If they fall down, they must quickly stand back up again by pressing
          Z. The player cannot spam Z as it has its own cooldown, and must avoid
          falling too many times within short intervals.&nbsp;
        </p>
  ...
  somethingsfishy: {
    ...
    video: require("../games/somethingsfishy/SomethingsFishy.mp4"),
    ...
    short: (
      <>
        A fishy game about sea creatures, a sushi restaurant and everything in
        between.
      </>
    ),
    description: (
      <>
        <p>
          <strong>"Something's Fishy"</strong>&nbsp;is à game about working as a
          QA Tester at a Sushi restaurant, made for my 2nd-year assignment at
          RMIT Vietnam.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>Fonts:</strong>&nbsp;Sik's font pack<span></span> by Sik
          </li>
          <li>
            <strong>Music &amp; SFXs:</strong> My broken tunes, my dusty guitar,
            my face towel, my milk tea cup + wrap,&nbsp;and all&nbsp;the
            food&nbsp;enjoyers at the school canteen.
          </li>
        </ul>
      </>
    ),
  ...
  mineblast: {
    ...
    video: require("../games/mineblast/Mineblast.mp4"),
    ...
    short: (
      <>
        Match ores to make larger and more valuable ores. Use TNT to make space!
      </>
    ),
    description: (
      <>
        ...
        <ul>
          <li>
            Left and Right Arrow Keys (A &amp; D)&nbsp;to move Magnet back and
            forth
          </li>
          <li>Press the Space Bar to attract and drop materials</li>
          <li>Press Esc to go back to the Main Menu</li>
        </ul>
        <p>
          <strong>Credits:</strong>
        </p>
        <ul>
          <li>Nhu (Water Melon)</li>
          <li>Bao (Theguyser)</li>
        </ul>
        <p>
        ...
        <ul>
          <li>
            ...
            <ul>
              <li>TNT Explosion</li>
              <li>Collecting Item Sound</li>
              <li>Breaking Stone Sounds</li>
            </ul>
          </li>
        </ul>
        <ul>
          <li>Kirby Return to Dreamland: White Wafers Bonus Area as BGM</li>
        </ul>
      </>
    ),
    category: "arcade",
